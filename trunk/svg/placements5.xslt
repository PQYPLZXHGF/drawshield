    ...
    <xsl:choose>
      ...
      <xsl:when test="parent::modifier[@name='on']/parent::ordinary">
        ...
        <xsl:choose>
          ...
          <xsl:when test="$ordsubtype='orle' and $chief='false'">x///////////130,300,80,80:870,300:500,120:500,1070:130,700:870,700:250,120:750,120:250,970:750,970:130,500:870,500</xsl:when>
